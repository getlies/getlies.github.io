...
import newspaper from "../assets/cat/newspaper.webp";
          ...
          <div className="icon-text mb-4">
            <span>
              ...
              <a
                ...
                href="mailto:morphoit@gmail.com"
                target="_blank"
                rel="noopener noreferrer"
              >
                <p>morphoit@gmail.com</p>
              </a>
            </span>
          </div>
          <div className="icon-text mb-4">
            <span>
              <img src={discord} className="icon-shadow" alt="" />
              <a
                className="underline-highlight"
                href="https://discord.com/users/353639776609632256"
                target="_blank"
                rel="noopener noreferrer"
              >
                <p>.dprian</p>
